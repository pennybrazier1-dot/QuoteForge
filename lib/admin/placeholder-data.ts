...
export const PLACEHOLDER_CUSTOMER_JOURNEYS: CustomerJourneyPreview[] = [
  {
    id: "journey-default",
    href: "/request-quote",
    title: "Default enquiry demo",
    description: "Single-trade customer form preview — Smith Plumbing.",
    status: "live",
  ...
  },
  {
    ...
    title: "Multi-trade enquiry demo",
    description: "Customer service picker with multiple trades.",
    status: "preview",
  ...
  },
  {
    ...
    title: "Handyman enquiry demo",
    description: "Customer-facing handyman service list preview.",
    status: "preview",
