...
export const TRADER_MOBILE_PAGE_SOURCES = {
  ...
  completedJobs: "app/(workspace)/completed-jobs/page.tsx",
  closedJobs: "app/(workspace)/closed-jobs/page.tsx",
  completedJobsScreen: "components/jobs/completed-jobs-screen.tsx",
  help: "app/(workspace)/help/page.tsx",
