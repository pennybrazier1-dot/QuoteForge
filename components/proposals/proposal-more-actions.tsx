...
function CancelConfirmForm({
  ...
  return (
    <form action={formAction} hidden={!open}>
...
function CancelConfirmDialog({
  ...
  return (
    <form
      id={`cancel-proposal-form-${proposalId}`}
...
export function ProposalMoreActions({
  ...
  const [cancelState, cancelAction] = useActionState(cancelProposal, initialState);
  const [deleteState, deleteAction] = useActionState(deleteProposal, initialState);
